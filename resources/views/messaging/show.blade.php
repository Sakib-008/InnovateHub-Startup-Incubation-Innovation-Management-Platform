    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header d-flex align-items-center gap-2">
                ...
                {{-- Typing indicator --}}
                <span id="typingIndicator" class="d-none ms-auto text-muted small">
            ...
            {{-- Message thread --}}
            <div class="card-body p-3" style="height:420px; overflow-y:auto;" id="thread">
            ...
            {{-- Send form — handled by AJAX in app.js --}}
